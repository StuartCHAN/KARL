...
class TransformerS2Model(FairseqEncoderDecoderModel):
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens, bert_input, **kwargs):
        ...
        bert_encoder_out, _ =  self.bert_encoder(bert_input, output_all_encoded_layers=True, attention_mask= ~ bert_encoder_padding_mask ) # attention_mask= 1. - bert_encoder_padding_mask)
