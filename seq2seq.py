...
class Seq2SeqModel:
    ...
    def trainItersBert(self, pairs):
        nl.trainItersBert(self.encoder, self.decoder, 75000, pairs, print_every=500, learning_rate=0.01, mom=0.001) 
        
    def translate(self, sentence):
        output_words, attentions = nl.evaluate(self.encoder, self.decoder, sentence )
